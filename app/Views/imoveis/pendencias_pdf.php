<?php
/**
 * Relatório de pendências (documento standalone para impressão / salvar como PDF).
 * @var array      $im
...
<head>
  <meta charset="UTF-8">
  <title>Pendências — <?= h($im['codigo']) ?></title>
  <style>
...
<body>
  ...
  <div class="cabecalho">
    ...
    <div class="sub"><?= h($im['codigo']) ?> · <?= h($im['nome_referencia']) ?></div>
  </div>
