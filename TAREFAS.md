...
- [ ] ⚠️ **[Gilson] Rodar migrations novas no banco de PRODUÇÃO**: `sql/migration_modulo_10_investimentos.sql` + `sql/migration_modulo_04_fornecedores.sql` (Módulos 10 e 04 — tabelas novas). Selecionar `u250260449_cezar_db` e remover o `USE gestao_patrimonial;`. Local já aplicado.
