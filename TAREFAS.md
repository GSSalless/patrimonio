...
- [ ] ⚠️ **[Gilson] Rodar `sql/migration_modulo_10_investimentos.sql` no banco de PRODUÇÃO** (Módulo 10 — tabelas novas). Selecionar `u250260449_cezar_db` e remover o `USE gestao_patrimonial;`. Local já aplicado.
